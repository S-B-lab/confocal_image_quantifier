...
function two_channel(stack_title, color_use1, color_use2, color_discard){
	imageCalculator("Multiply create stack", stack_title+" ("+color_use1+")", stack_title+" ("+color_use2+")");
...
function three_channel(stack_title, color_use1, color_use2, color_use3){
	...
	selectWindow(stack_title+" ("+color_use2+")");
	close();
	imageCalculator("Multiply stack", "Result of "+stack_title+" ("+color_use1+")", stack_title+" ("+color_use3+")");
	selectWindow(stack_title+" ("+color_use3+")");
	close();
}
...
print("\\Clear");
print("Channels used:");
if(red_channel_logical ==1 ){print("Red Channel");};
if(green_channel_logical ==1 ){print("Green Channel");};
if(blue_channel_logical ==1 ){print("Blue Channel");};
print(" ");
print("Settings used:");
print("Cell size (min): "+cell_size_min);
print("Cell size (max): "+cell_size_max);
print("Cell circularity (min): "+circularity_min);
print("Cell circularity (max): "+circularity_max);
